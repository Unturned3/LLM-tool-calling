from inference import generate_problem_prompt
...
batches = simulate_poisson_batch_arrivals_exhaustive(
    prompts=all_prompts,
...
batches_sample = simulate_poisson_batch_arrivals_exhaustive(
    prompts=all_prompts[5::20],
